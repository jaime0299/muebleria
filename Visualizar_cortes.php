...
$consultar_datos="SELECT * from cortes where id='$id'";
$obtener_datos=$mysqli -> query($consultar_datos);
$dato=mysqli_fetch_assoc($obtener_datos);
...
$fecha_inicial_fi =$dato['fecha_ini'];//VARIABLE A REMPLAZAR POR LA DE POST
...
$fecha_final_ff =$dato['fecha_fin'];//VARIABLE A REMPLAZAR POR LA DE POST
